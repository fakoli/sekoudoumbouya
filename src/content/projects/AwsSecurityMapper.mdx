...
- **Created cross-VPC detection logic** that identifies and visually distinguishes relationships spanning VPC boundaries, which is critical for understanding blast radius and network segmentation.
