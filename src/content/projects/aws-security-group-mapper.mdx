...
I wanted something in the middle: **a focused mapper that turns SG relationships into a graph you can actually see and discuss.**
...
- Reduces time to assess blast radius from “days of grep and guesswork” to “one diagram.”
- Lowers the risk of hidden, overly-permissive security groups across accounts.
- Demonstrates a reusable pattern: lightweight infra visibility tools that plug into existing AWS usage instead of requiring a heavy new platform.
...
Even as a personal tool, it serves as a strong demonstration of how I approach **security, observability, and developer ergonomics** at the cloud networking layer.
...
- Demonstrated my ability to move from **conceptual cloud security concerns** to a concrete, inspectable tooling solution.
