...
contributions:
  - >-
    Designed extraction-synthesis separation architecture where extraction agents
    gather facts with source anchors, and synthesis agents connect findings into
    decisions
  - >-
...
decisionCard:
  problem: >-
    ...
    surface while hiding the complexity that matters most. Cost mechanics
  ...
  constraints:
    ...
    - >-
      ...
      certainty
    - >-
      Agents must have narrow, auditable roles with no omniscient single-agent
      designs
    - >-
